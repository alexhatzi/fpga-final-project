...
#
# Script generated by Vivado on Thu Nov 14 18:08:57 EST 2024
...
# script info
echo -e "block_dm.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L dist_mem_gen_v8_0_15 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot block_dm xil_defaultlib.block_dm xil_defaultlib.glbl -log elaborate.log
}

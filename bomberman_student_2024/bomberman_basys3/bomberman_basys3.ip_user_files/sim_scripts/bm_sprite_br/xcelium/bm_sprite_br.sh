...
#                script (type 'bm_sprite_br.sh -help' for more information).
#
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bm_sprite_br xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bm_sprite_br -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bm_sprite_br_sc.so .tmp_log xcelium_lib waves.shm c.obj)

...
#
# Script generated by Vivado on Thu Nov 21 09:00:17 EST 2024
...
#
# Usage        : enemy_sprite_br.sh
#                enemy_sprite_br.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                enemy_sprite_br.sh [-reset_run]
#                enemy_sprite_br.sh [-reset_log]
#                enemy_sprite_br.sh [-help]
#
...
#                script (type 'enemy_sprite_br.sh -help' for more information).
#
...
# script info
echo -e "enemy_sprite_br.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./enemy_sprite_br.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.enemy_sprite_br xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.enemy_sprite_br -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/alex/secondaryLinux/FPGALAB/fpga-final-project/bomberman_student_2024/bomberman_basys3/bomberman_basys3.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log enemy_sprite_br_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: enemy_sprite_br.sh [-step]\n\
Usage: enemy_sprite_br.sh [-lib_map_path]\n\
Usage: enemy_sprite_br.sh [-reset_run]\n\
Usage: enemy_sprite_br.sh [-reset_log]\n\
Usage: enemy_sprite_br.sh [-keep_index]\n\

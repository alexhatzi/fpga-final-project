...
#
# Script generated by Vivado on Sat Nov 09 19:29:31 EST 2024
...
#
# Usage        : explosions_br.sh
#                explosions_br.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                explosions_br.sh [-reset_run]
#                explosions_br.sh [-reset_log]
#                explosions_br.sh [-help]
#
...
# script info
echo -e "explosions_br.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./explosions_br.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot explosions_br xil_defaultlib.explosions_br xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb explosions_br.wdb xsim.dir libdpi.so)
...
Usage: explosions_br.sh [-step]\n\
Usage: explosions_br.sh [-lib_map_path]\n\
Usage: explosions_br.sh [-reset_run]\n\
Usage: explosions_br.sh [-reset_log]\n\
Usage: explosions_br.sh [-keep_index]\n\

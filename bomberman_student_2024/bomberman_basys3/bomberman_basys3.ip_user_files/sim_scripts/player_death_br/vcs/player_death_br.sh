...
#                script (type 'player_death_br.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.player_death_br xil_defaultlib.glbl -o player_death_br_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./player_death_br_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key player_death_br_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc player_death_br_simv.daidir vcs_lib c.obj)

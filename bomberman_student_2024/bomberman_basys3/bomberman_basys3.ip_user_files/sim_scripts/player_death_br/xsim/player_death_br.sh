...
#
# Script generated by Vivado on Sat Nov 09 19:18:34 EST 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : player_death_br.sh
...
#
# Usage        : player_death_br.sh
#                player_death_br.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                player_death_br.sh [-reset_run]
#                player_death_br.sh [-reset_log]
#                player_death_br.sh [-help]
#
...
# script info
echo -e "player_death_br.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./player_death_br.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot player_death_br xil_defaultlib.player_death_br xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim player_death_br -key {Behavioral:sim_1:Functional:player_death_br} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/alex/secondaryLinux/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb player_death_br.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./player_death_br.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: player_death_br.sh [-help]\n\
Usage: player_death_br.sh [-step]\n\
Usage: player_death_br.sh [-lib_map_path]\n\
Usage: player_death_br.sh [-reset_run]\n\
Usage: player_death_br.sh [-reset_log]\n\
Usage: player_death_br.sh [-keep_index]\n\
Usage: player_death_br.sh [-noclean_files]\n\n\
